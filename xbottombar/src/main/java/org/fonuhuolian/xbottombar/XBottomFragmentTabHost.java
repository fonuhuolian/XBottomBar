...
public class XBottomFragmentTabHost extends TabHost implements
    ...
    public XBottomFragmentTabHost(Context context) {
    ...
    public XBottomFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
